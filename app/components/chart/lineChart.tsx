...
function getOptions(
    ...
    lineDataArray: LineDataType[],
    index: string[]
): Highcharts.Options {
    const theme = useMantineTheme()
    const colorScheme =
        useColorScheme() === 'dark' ? theme.colors.dark[0] : theme.black
    const dataColor =
        useColorScheme() === 'dark'
            ? theme.colors.secondaryColor[2]
    ...
    const plotOptions: Highcharts.Options = {
        ...
        series: lineDataArray.map((lineData, index) => ({
            ...
            dataLabels: {
                ...
                formatter:
                    lineData.formatter ||
                    getSerieFormatterByType(lineData.unit),
            },
            data: lineData.serie,
            type: 'line',
            selected: index === 0,
    ...
    if (redirect && plotOptions.plotOptions?.series?.events) {
        plotOptions.plotOptions.series.events.click = function (
