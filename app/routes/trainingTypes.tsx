      ...
      <Stack gap="xl">
        <WeekTypeCard
          ...
          content={[
            ...
            {
              title: "Intervalle",
              text: "10 minutes à l'intensité I (ex: 2 x 5 min I, 2 min réc)",
              icon: <CellSignal3 />,
            },
            {
              title: "Repetition",
              text: "5 minutes à l'intensité R (ex: 5 x 1 min R, 1 min réc, ou 5 x 400m R, 400m réc, ou 10 x 200m R, 200m réc)",
              icon: <CellSignal5 />,
            },
